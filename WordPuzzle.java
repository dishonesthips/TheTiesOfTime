...
public class WordPuzzle
{
  ...
  private void initialize() //This method declares variables or resets them if the boolean "restart" is true
  {
    ...
    for(int i = 0; i < bounceX.length; i++)
    {
      ...
      bounceX[i]= (int) (Math.random()* 750) + 60;
      bounceY[i]= (int) (Math.random() * 130) + 60;
  ...
  public WordPuzzle(boolean cheat)//(GameStateManager manage) //Communicates with the GameStateManager
  {
    this.cheat = cheat;
